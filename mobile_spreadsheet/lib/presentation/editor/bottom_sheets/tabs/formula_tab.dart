...
class FormulaTab extends StatelessWidget {
  const FormulaTab({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildCard([
              _buildOptionTile(Icons.functions, 'AutoSum'),
              Divider(height: 1, thickness: 1, color: Colors.grey.shade200, indent: 48),
              _buildOptionTile(Icons.history, 'Recently Used'),
              Divider(height: 1, thickness: 1, color: Colors.grey.shade200, indent: 48),
              _buildOptionTile(Icons.account_balance_wallet_outlined, 'Financial'),
              Divider(height: 1, thickness: 1, color: Colors.grey.shade200, indent: 48),
              _buildOptionTile(Icons.calculate_outlined, 'Math & Trig'),
            ]),
